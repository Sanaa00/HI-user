    ...
    <div className="mt-16 min-h-screen p-4 sm:px-10 md:px-20  flex flex-col lg:items-center">
      ...
      <div className="mt-5 flex justify-between  text-lg lg:w-1/2">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-sm text-neutral-400 ">Blood Type</span>
        </div>{' '}
        {/* </div>{' '} */}
        {/* <div className="mt-2 flex justify-between items-center lg:w-1/2"> */}
        <div className="flex flex-col items-center">
          {' '}
          <span className="ml-2 font-bold">172 cm</span> <span>Height</span>
        </div>{' '}
        <div className="flex flex-col items-center">
          {' '}
          <span className="ml-2 font-bold">78 kg</span>
          <span>weight</span>
        </div>{' '}
      </div>{' '}
      {/* </div> */}
