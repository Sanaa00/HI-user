...
function Login() {
  ...
  return (
    <div className="mt-16 p-4 sm:px-10 md:px-20 grid grid-cols-1 md:grid-cols-2 items-start lg:gap-20  min-h-screen">
      ...
      <Formik>
        <div className="w-full flex  flex-col items-center justify-center md:mt-28 mt-5 sm:mt-0">
