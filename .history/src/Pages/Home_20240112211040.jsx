...
function Home() {
  ...
  return (
    <div className="mt-16 min-h-screen p-4 sm:px-10 md:px-20  flex flex-col lg:items-center">
      ...
      {/* **********vital information*********** */}
      <div className="mt-5 p-4 flex justify-between  text-lg lg:w-1/2">
        {' '}
        {/* <div className="mt-2 flex justify-between items-center lg:w-1/2"> */}
        ...
        <div className="flex flex-col items-center">
          {' '}
          <div className="ml-2 text-xl font-bold">172 cm</div>{' '}
          <div className="text-sm font-semibold text-neutral-400 ">Height</div>
        </div>{' '}
        <div className="flex flex-col items-center">
          {' '}
          <div className="ml-2 text-xl font-bold">78 kg</div>
          <div className="text-sm font-semibold text-neutral-400 ">weight</div>
        </div>{' '}
      </div>{' '}
      {/* </div> */}
      {/* <div className="mt-2 flex justify-between items-center lg:w-1/2">
