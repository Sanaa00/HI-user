  ...
  return (
    <div className="mt-16 min-h-screen p-4 sm:px-10 md:px-20  flex flex-col lg:items-center">
      <div className="flex justify-center items-center">
        {console.log(data)}{' '}
        <img
          className="object-cover rounded-full w-72 border-2 border-neutral-50 h-72 lg:w-1/2 lg:h-96 "
          src={data.userImage}
          alt="user"
        />
      </div>
      ...
      {/* </div>{' '} */}
      <div className="mt-5 bg-blue-400 text-neutral-50 rounded-md p-4 shadow ">
        {' '}
        <div className="mt-2 flex justify-between items-center lg:w-1/2">
      ...
      {/* **********vital information*********** */}
      <div className="mt-5  grid grid-cols-3 gap-5 justify-between items-center  text-lg lg:w-1/2">
        {' '}
        {/* <div className="mt-2 flex justify-between items-center lg:w-1/2"> */}
        <div className="w-full flex flex-col items-center justify-center bg-neutral-50 p-4 rounded-md shadow-sm ">
          {' '}
          <div className="ml-2 text-xl font-bold">O+</div>
          <div className="text-sm font-semibold text-neutral-400 mt-2">
            Blood
          </div>
        </div>{' '}
        {/* </div>{' '} */}
        {/* <div className="mt-2 flex justify-between items-center lg:w-1/2"> */}
        <div className="flex w-full flex-col justify-center items-center bg-neutral-50 p-4 rounded-md shadow-sm">
          {' '}
        ...
        <div className="flex flex-col justify-center items-center bg-neutral-50 p-4 rounded-md shadow-sm w-full">
          {' '}
